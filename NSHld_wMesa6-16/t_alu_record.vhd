...
-- ALU has additional mantissa bits to support the implicit leading one bit & half bit
...
package t_alu_record is
    ...
    type t_alu_record is record
      sign:   std_logic;
      znan:   std_logic;  				  -- zero or NAR depending on sign bit
      expon:  signed(expon_sz downto 0);  -- signed for ease of expansion and use plus additional overflow bit
      frac:   unsigned(frac_sz downto 0); -- include hidden leading bit & half bit
 end record;
